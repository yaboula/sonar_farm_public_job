...
local function toRecord(payload)
    return {
        ...
        data = {
            ...
            plantingQuality = payload.plantingQuality,
            ...
            waterProtectionStrength = payload.waterProtectionStrength,
            waterProtectionUntil = payload.waterProtectionUntil,
            waterProtectionTier = payload.waterProtectionTier,
            waterProtectionItem = payload.waterProtectionItem,
            ...
            weedProtectionStrength = payload.weedProtectionStrength,
            weedProtectionUntil = payload.weedProtectionUntil,
            weedProtectionTier = payload.weedProtectionTier,
            weedProtectionItem = payload.weedProtectionItem,
