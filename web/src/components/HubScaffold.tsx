...
export function HubScaffold({ eyebrow, title, subtitle, toolbar, aside, children }: HubScaffoldProps) {
  return (
    <section className="hub-view">
      <div className="hub-backdrop" aria-hidden="true" />
      <header className="hub-intro"><span>{eyebrow}</span><h1>{title}</h1><p>{subtitle}</p></header>
